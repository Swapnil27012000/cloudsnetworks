                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tg-breadcrumb__content z-index-3 text-center">
                            <h3 class="tg-breadcrumb__title">Blog Details</h3>
                ...
                <div class="row gx-30">
                    <div class="col-xl-8 col-lg-8">
                        <div class="blog-post-wrap">
                            <article>
                                <div class="blog__details-thumb p-relative mb-30">
                                    <img src="assets/img/blog/details-1-4.jpg" alt="">
                                    <div class="blog-post-meta">
                                        <span><i class="fa-regular fa-calendar-days"></i>October 19, 2022</span>
                                        <span><i class="fa-light fa-user"></i>By admin</span>
                                        <span><i class="fa-regular fa-folder-open"></i>Category</span>
                                    </div>
                                </div>    
                                <div class="blog__details-content">
                                    <div class="post-text mb-40">
                                        <h4 class="blog__details-title mb-20"><a href="#">Simplify IT for Enhanced Productivity</a></h4>
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries into electronic Lorem Ipsum is simply dummy </p>
                                    </div>
                                    <blockquote>
                                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters</p>
                                        <span>Mark wood</span>
                                    </blockquote>
                                    <div class="blog__details-inner mt-40 mb-20">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                <div class="blog__details-inner-content">
                                                    <p>Contrary to popular belief, Lorem Ipsum is not simply the a random text. It has roots in a piece of classical Latin and literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tg-post-tag d-flex justify-content-between align-items-center">
                                        <div class="tagcloud">
                                            <a href="#">Medicine</a>
                                            <a href="#">Doctors</a>
                                            <a href="#">Babyhealthcare</a>
                                        </div>
                                        <span>Comment (6)</span>
                                    </div>
                                    <div class="postbox-more-wrap mb-60">
                                        <div class="row align-items-center">
                                              ...
                                              <div class="postbox-more-left d-flex align-items-center justify-content-start">
                                                <div class="postbox-more-icon">
                                                 ...
                                                 <div class="postbox-more-content">
                                                    <a href="blog-details.php">We have Solutions <br> for Agri Need</a>
                                                 </div>
                                              </div>
                                           </div>
                                           <div class="col-md-6 col-sm-6">
                                              <div
                                                 class="postbox-more-right d-flex align-items-center justify-content-start justify-content-sm-end">
                                                 <div class="postbox-more-content">
                                                    <a href="blog-details.php"> Experience the <br> Future of IT</a>
                                                 </div>
                                                 <div class="postbox-more-icon">
                                                    <a href="blog-details.php">
                                ...
                                <h3 class="postbox__comment-title pb-30">Elevate Your Business with IT Solutions</h3>
                                          ...
                                          <div class="postbox__comment-box p-relative">
                                             <div class="postbox__comment-info d-flex align-items-start">
                                                ...
                                                <div class="postbox__comment-name p-relative">
                                                   <h5>Mike Dooley</h5>
                                                   <span>December 23,2023 at 8:50 P.M</span>
                                                   <div class="postbox__comment-text">
                                                        <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. RichardClintock</p>
