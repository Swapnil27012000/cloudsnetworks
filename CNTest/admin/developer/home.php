...
$developer_id = $_SESSION['developer'];
set_marathi_sql_config($con);
$query = "SELECT * FROM users WHERE u_id='$developer_id'";
...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Clouds Networks || Dashboard</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="text-dark mb-0"><?php echo $Name?><span class="badge bg-soft-success text-success ms-1"><?php echo $user_type?></span></h6>
