                ...
                <div class="row gx-30">
                    <div class="col-xl-4 col-lg-4">
                        <div class="tg-contact-left">
                            <h4 class="tg-section-title mb-30">Get touch Here?</h4>
                            <div class="tg-contact-item-wrap">
                                ...
                                <div class="tg-contact-item d-flex align-items-center mb-20">
                                    ...
                                    <div class="tg-contact-info">
                                        <h5>Email </h5>
                                        <a href="mailto:<?php echo $Contact_Email ?>">business.cloudsnetworks<br>@outlook.com</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="tg-contact-icon">
                                        <span>
                                            <svg width="28" height="26" viewBox="0 0 28 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M18.9448 25.5547H0.437525C0.218762 25.5547 0 25.3797 0 25.1172C0 24.8547 0.17501 24.6797 0.437525 24.6797H18.9448C19.1636 24.6797 19.3823 24.8547 19.3823 25.1172C19.3823 25.3797 19.1636 25.5547 18.9448 25.5547Z" fill="white"/>
                                                <path d="M18.9478 25.5554H3.1094C2.89064 25.5554 2.67188 25.3804 2.67188 25.1178V13.961C2.67188 13.7422 2.84688 13.5234 3.1094 13.5234C3.37191 13.5234 3.54692 13.6984 3.54692 13.961V24.6803H18.9478C19.1666 24.6803 19.3853 24.8553 19.3853 25.1178C19.3853 25.3804 19.1666 25.5554 18.9478 25.5554Z" fill="white"/>
                                                <path d="M1.96886 14.836C1.44383 14.836 0.962554 14.661 0.568782 14.2672C0.218762 13.9172 0 13.3921 0 12.8671C0 12.3858 0.218762 11.9046 0.52503 11.5108L10.5443 1.49147C11.9444 0.0913866 14.1758 0.0913866 15.5759 1.49147L19.8636 5.77921C20.0386 5.95422 20.0386 6.21673 19.8636 6.39174C19.6886 6.56675 19.4261 6.56675 19.2511 6.39174L14.9633 2.104C13.9133 1.05394 12.2069 1.05394 11.1569 2.104L1.18132 12.0796C1.00631 12.2983 0.875049 12.6046 0.875049 12.8671C0.875049 13.0859 0.918802 13.3921 1.18132 13.6546C1.61884 14.0922 2.36263 14.0922 2.80016 13.6546L12.7757 3.67909C12.9507 3.50408 13.2132 3.50408 13.3883 3.67909L17.0197 7.31054C17.1947 7.48555 17.1947 7.74807 17.0197 7.92308C16.8447 8.09809 16.5822 8.09809 16.4072 7.92308L13.082 4.59789L3.41269 14.2672C3.01892 14.661 2.49389 14.836 1.96886 14.836Z" fill="white"/>
                                                <path d="M14.3945 25.5568H8.18167C7.9629 25.5568 7.74414 25.3818 7.74414 25.1193V17.1563C7.74414 16.4563 8.31292 15.8438 9.05671 15.8438H13.5632C14.2633 15.8438 14.832 16.4563 14.832 17.1563V25.1193C14.832 25.338 14.6133 25.5568 14.3945 25.5568ZM8.61919 24.6817H13.957V17.1563C13.957 16.8938 13.7382 16.7188 13.5632 16.7188H9.05671C8.7942 16.7188 8.61919 16.9376 8.61919 17.1563V24.6817Z" fill="white"/>
                                                <path d="M21.6554 25.5096C21.0867 25.5096 20.5616 25.2034 20.2554 24.7221C18.724 22.1844 15.2676 16.0591 15.2676 13.434C15.2676 9.93375 18.1115 7.08984 21.6117 7.08984C25.1119 7.08984 27.9995 9.93375 27.9995 13.434C27.9995 15.2716 26.337 19.0343 23.0993 24.7221C22.7492 25.2034 22.2242 25.5096 21.6554 25.5096ZM21.6117 7.96489C18.5928 7.96489 16.1426 10.415 16.1426 13.434C16.1426 15.8841 19.8616 22.3595 20.9991 24.2846C21.1304 24.5033 21.3929 24.6783 21.6992 24.6783C22.0055 24.6783 22.2242 24.5471 22.3992 24.2846C26.2932 17.4154 27.1245 14.5715 27.1245 13.434C27.1245 10.415 24.6744 7.96489 21.6117 7.96489Z" fill="white"/>
                                                <path d="M21.6588 17.5051C19.4274 17.5051 17.5898 15.6675 17.5898 13.4362C17.5898 11.2048 19.4274 9.36719 21.6588 9.36719C23.8902 9.36719 25.7278 11.2048 25.7278 13.4362C25.7278 15.6675 23.8902 17.5051 21.6588 17.5051ZM21.6588 10.2422C19.9087 10.2422 18.4649 11.6861 18.4649 13.4362C18.4649 15.1863 19.9087 16.6301 21.6588 16.6301C23.4089 16.6301 24.8528 15.1863 24.8528 13.4362C24.8528 11.6861 23.4089 10.2422 21.6588 10.2422Z" fill="white"/>
                                                <path d="M9.49417 21.4868C9.2754 21.4868 9.05664 21.3118 9.05664 21.0493V20.4805C9.05664 20.2617 9.23165 20.043 9.49417 20.043C9.75668 20.043 9.93169 20.218 9.93169 20.4805V21.0493C9.93169 21.268 9.71293 21.4868 9.49417 21.4868Z" fill="white"/>
                                            </svg> 
                                        </span>
                                    </div>
                                    <div class="tg-contact-info">
                                        <h5>Contacts </h5>
                                        <a target="_blank" href="<?php echo $address_link ?>"><?php echo $address_url ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="tg-contact-map">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3818.5005652037275!2d73.537903!3d16.851115!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTbCsDUxJzA0LjAiTiA3M8KwMzInMTYuNSJF!5e0!3m2!1sen!2sin!4v1740214137566!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                    </div>
                </div>
                    ...
                    <div class="row gx-30">
                        <div class="col-xl-4 col-lg-4">
                            <div class="tg-contact-box">
                                <h4 class="tg-section-title mb-20">Do you have any question? </h4>
                            ...
                            <div class="tg-contact-form">
                                ...
                                <form action="submit.php" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 mb-20">
                                            <div class="tg-contact-input-box-2">
                                                <input name="phone" id="mobile" type="text" placeholder="Phone Number" minlength="10" maxlength="10" oninput="numbersOnly();">
                                                <script>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 mb-20">
                                            <div class="tg-contact-input-box-2">
                                                <input name="subject" type="text" placeholder="Subject" minlength="2" maxlength="500">
                                            </div>
                                        </div>
                                        <div class="col-xl-12 mb-20">
                                            <div class="tg-contact-textarea-box-2">
                                                <textarea name="message" type="text" placeholder="Your Message" minlength="2" maxlength="10000"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="tg-contact-button">
                                                <button class="tg-btn-gradient w-100" name="con_submit" type="submit">submit now</button>
