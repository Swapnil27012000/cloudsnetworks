                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                        <div class="tg-service-3-item text-center">
                            ...
                            <div class="tg-service-3-content">
                                <h5 class="tg-service-3-title pb-20"> <a href="service-details.php">IT Consultation</a>
                                </h5>
                                <p>Improving your business's is be online presence can</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                        <div class="tg-service-3-item text-center">
                            ...
                            <div class="tg-service-3-content">
                                <h5 class="tg-service-3-title pb-20"> <a href="service-details.php">Network Setup</a>
                                </h5>
                                <p>Improving your business's is be online presence can</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                        <div class="tg-service-3-item text-center">
                            ...
                            <div class="tg-service-3-content">
                                <h5 class="tg-service-3-title pb-20"> <a href="service-details.php">Data Backup</a>
                                </h5>
                                <p>Improving your business's is be online presence can</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                        <div class="tg-service-3-item text-center">
                            ...
                            <div class="tg-service-3-content">
                                <h5 class="tg-service-3-title pb-20"> <a href="service-details.php">Tech Solutions Pro</a>
                                </h5>
                                <p>Improving your business's is be online presence can</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                        <div class="tg-service-3-item text-center">
                            ...
                            <div class="tg-service-3-content">
                                <h5 class="tg-service-3-title pb-20"> <a href="service-details.php">Code Crafters</a>
                                </h5>
                                <p>Improving your business's is be online presence can</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                        <div class="tg-service-3-item text-center">
                            ...
                            <div class="tg-service-3-content">
                                <h5 class="tg-service-3-title pb-20"> <a href="service-details.php">Byte Genius</a>
                                </h5>
                                <p>Improving your business's is be online presence can</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                        <div class="tg-service-3-item text-center">
                            ...
                            <div class="tg-service-3-content">
                                <h5 class="tg-service-3-title pb-20"> <a href="service-details.php">Net Ninjas</a>
                                </h5>
                                <p>Improving your business's is be online presence can</p>
                            </div>
                        </div>
